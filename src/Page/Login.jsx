    ...
    return (
        <div className="flex bg-slate-400 h-screen items-center justify-center">
            <form onSubmit={handleSubmit(onSubmit)} className="flex   flex-col p-6 bg-white md:w-1/3 rounded-md"  action="">
                <h1 className="text-center text-slate-900 text-2xl font-semibold mb-8">LogIn</h1>
                ...
                <button className="mx-auto bg-slate-700 px-4 py-1 mt-4 rounded-lg text-[18px] font-semibold text-white">LogIn</button>
            </form>
